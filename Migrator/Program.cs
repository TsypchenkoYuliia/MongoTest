...
namespace Migrator
{
    ...
    class Program
    {
        ...
        static string mongoConnectionString = "mongodb+srv://mflixAppUser:mflixAppPwd@mflex.csvpt.mongodb.net/mflex?retryWrites=true&w=majority&maxPoolSize=50&wtimeoutMS=2500";
        ...
        static async Task Main(string[] args)
        {
            ...
            if (datePipelineResults.Count > 0)
            {
                ...
                {
                    var filter = Builders<Movie>.Filter.Eq("Id", item.Id);
                    requests.Add(new ReplaceOneModel<Movie>(filter, item));
                }
